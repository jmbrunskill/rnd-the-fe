...
export type ActivityLogNodeType =
  ...
  | 'ASSET_UPDATED'
  | 'BUNDLED_ITEM_CREATED'
  | 'BUNDLED_ITEM_DELETED'
  | 'BUNDLED_ITEM_UPDATED'
  ...
  | 'PACKAGING_VARIANT_CREATED'
  | 'PACKAGING_VARIANT_DELETED'
  | 'PACKAGING_VARIANT_UPDATED'
  | 'PATIENT_CREATED'
  | 'PATIENT_UPDATED'
...
export type ActivityLogSortFieldInput =
  | 'activityLogType'
  | 'id'
  | 'recordId'
  | 'userId';
...
export type AddToPurchaseOrderFromMasterListResponse = AddToPurchaseOrderFromMasterListError | PurchaseOrderLineConnector;
...
export type AdminUserCreationFailed = InitialiseAsCentralServerErrorInterface & {
 ...
 */
export type AncillaryStateNode =
  | 'NEEDS_ADD'
  | 'NEEDS_UPDATE'
  | 'NONE';
...
export type AssetCatalogueItemSortFieldInput =
  | 'catalogue'
  | 'code'
  | 'manufacturer'
  | 'model';
...
export type AssetCategorySortFieldInput =
  | 'name';
...
export type AssetClassSortFieldInput =
  | 'name';
...
export type AssetLogReasonSortFieldInput =
  | 'status';
...
export type AssetLogSortFieldInput =
  | 'logDatetime'
  | 'status';
...
export type AssetLogStatusNodeType =
  | 'DECOMMISSIONED'
  | 'FUNCTIONING'
...
export type AssetLogTypeNodeType =
  | 'STATUS_UPDATE'
  | 'TEMPERATURE_MAPPING';
...
export type AssetSortFieldInput =
  | 'assetNumber'
  | 'installationDate'
  | 'modifiedDatetime'
  | 'notes'
...
export type AssetTypeSortFieldInput =
  | 'name';
...
export type CampaignSortFieldInput =
  | 'name';
...
export type CannotEditPurchaseOrder = AddToPurchaseOrderFromMasterListErrorInterface & InsertPurchaseOrderLineErrorInterface & PurchaseOrderLineError & {
...
export type CannotHaveEstimatedDeliveryDateBeforeShippedDate = UpdateErrorInterface & {
...
export type CannotReceiveWithPendingLines = UpdateInboundShipmentErrorInterface & {
...
export type ClinicianSortFieldInput =
  | 'address1'
  | 'address2'
  | 'code'
  | 'email'
...
export type ContactFormNodeType =
  | 'FEEDBACK'
  | 'SUPPORT';
...
export type ContactTraceSortFieldInput =
  | 'contactTraceId'
  | 'dateOfBirth'
  | 'datetime'
  | 'firstName'
...
export type CurrencySortFieldInput =
  | 'currencyCode'
  | 'id'
  | 'isHomeCurrency';
...
export type DatabaseError = DeleteAssetCatalogueItemErrorInterface & DeleteAssetErrorInterface & DeleteAssetLogReasonErrorInterface & DeleteCampaignErrorInterface & DeleteLocationErrorInterface & InsertAssetCatalogueItemErrorInterface & InsertAssetErrorInterface & InsertAssetLogErrorInterface & InsertAssetLogReasonErrorInterface & InsertDemographicIndicatorErrorInterface & InsertDemographicProjectionErrorInterface & InsertLocationErrorInterface & NodeErrorInterface & RefreshTokenErrorInterface & ScannedDataParseErrorInterface & UpdateAssetErrorInterface & UpdateDemographicIndicatorErrorInterface & UpdateDemographicProjectionErrorInterface & UpdateLocationErrorInterface & UpdateSensorErrorInterface & UpsertAncillaryItemErrorInterface & UpsertBundledItemErrorInterface & UpsertCampaignErrorInterface & UpsertItemVariantErrorInterface & {
...
export type DeleteCampaignResponse = DeleteCampaignError | DeleteCampaignSuccess;
...
export type DeletePurchaseOrderLineResponse = DeletePurchaseOrderLineError | DeleteResponse;
...
export type DeletePurchaseOrderResponse = DeletePurchaseOrderError | DeleteResponse;
...
export type DemographicIndicatorSortFieldInput =
  | 'id'
  | 'name';
...
export type DemographicProjectionSortFieldInput =
  | 'id';
...
export type DemographicSortFieldInput =
  | 'id'
  | 'name';
...
export type DocumentRegistryCategoryNode =
  | 'CONTACT_TRACE'
  | 'CUSTOM'
  | 'ENCOUNTER'
  | 'PATIENT'
...
export type DocumentRegistrySortFieldInput =
  | 'documentType'
  | 'type';
...
export type DuplicateInboundShipmentResponse = DuplicateInboundShipmentError | DuplicateInboundShipmentNode;
...
export type DuplicateOutboundShipmentResponse = DuplicateOutboundShipmentError | DuplicateOutboundShipmentNode;
...
export type EncounterNodeStatus =
  | 'CANCELLED'
  | 'DELETED'
  | 'PENDING'
  | 'VISITED';
...
export type EncounterSortFieldInput =
  | 'Program'
  | 'Type'
  | 'createdDatetime'
  | 'endDatetime'
...
export type EqualFilterSensorTypeInput = {
  equalAny?: InputMaybe<Array<SensorNodeType>>;
  equalTo?: InputMaybe<SensorNodeType>;
  notEqualAll?: InputMaybe<Array<SensorNodeType>>;
  notEqualTo?: InputMaybe<SensorNodeType>;
};
...
export type FormSchemaSortFieldInput =
  | 'id';
...
export type IndicatorValueTypeNode =
  | 'NUMBER'
  | 'STRING';
...
export type InitialisationStatusType =
  /** Fuly initialised */
  | 'INITIALISED'
...
export type InitialiseAsCentralServerResponse = InitialiseAsCentralServerError | StandaloneCentralInitialisedNode;

export type InitialiseSiteResponse = SyncErrorNode | SyncErrorV7Node | SyncSettingsNode;
...
export type InsertFromResponseRequisitionResponse = InsertFromResponseRequisitionError | RequisitionNode;

export type InsertFromResponseStatusInput =
  | 'DRAFT'
  | 'SENT';
...
export type InsertPurchaseOrderLineResponse = IdResponse | InsertPurchaseOrderLineError;
...
export type InsertStockRelocationResponse = InsertStockRelocationError | InsertStockRelocationNode;
...
export type InstalledPluginKindType =
  | 'BACKEND'
  | 'FRONTEND';
...
export type InsurancePolicyNodeType =
  | 'BUSINESS'
  | 'PERSONAL';
...
export type InsuranceSortFieldInput =
  | 'expiryDate'
  | 'isActive';
...
export type InventoryAdjustmentReasonNodeType =
  | 'NEGATIVE'
  | 'POSITIVE';

export type InventoryAdjustmentReasonResponse = InventoryAdjustmentReasonConnector;

export type InventoryAdjustmentReasonSortFieldInput =
  | 'id'
...
export type InvoiceLineNodeType =
  | 'SERVICE'
  | 'STOCK_IN'
  | 'STOCK_OUT'
  | 'UNALLOCATED_STOCK';

export type InvoiceLineSortFieldInput =
  /** Invoice line batch */
  | 'batch'
...
export type InvoiceLineStatusType =
  | 'PASSED'
  | 'PENDING'
  | 'REJECTED';
...
export type InvoiceSortFieldInput =
  | 'allocatedDatetime'
  | 'comment'
  | 'createdDatetime'
  | 'deliveredDatetime'
...
export type ItemSortFieldInput =
  | 'code'
  | 'name'
  | 'type';
...
export type LedgerSortFieldInput =
  | 'datetime'
  | 'invoiceType'
  | 'itemId'
  | 'name'
...
export type LineLinkedToTransferredInvoice = DeleteInboundShipmentLineErrorInterface & {
...
export type LocationOnHold = InsertStockRelocationErrorInterface & UpdateStockRelocationErrorInterface & {
  __typename: 'LocationOnHold';
  description: Scalars['String']['output'];
  locationId: Scalars['String']['output'];
};

export type LocationSortFieldInput =
  | 'code'
  | 'name';
...
export type LocationTypeSortFieldInput =
  | 'id'
  | 'minTemperature'
  | 'name';
...
export type MasterListLineSortFieldInput =
  | 'code'
  | 'name';
...
export type MasterListNotFoundForThisStore = AddFromMasterListErrorInterface & AddToInboundShipmentFromMasterListErrorInterface & AddToPurchaseOrderFromMasterListErrorInterface & ResponseAddFromMasterListErrorInterface & {
  __typename: 'MasterListNotFoundForThisStore';
  description: Scalars['String']['output'];
};

export type MasterListSortFieldInput =
  | 'code'
  | 'description'
  | 'discountPercentage'
  | 'name';
...
export type NameSortFieldInput =
  | 'code'
  | 'name';
...
export type NotEnoughStock = InsertStockRelocationErrorInterface & UpdateStockRelocationErrorInterface & {
...
export type OtherPartyNotACustomer = InsertCustomerReturnErrorInterface & InsertErrorInterface & InsertResponseRequisitionErrorInterface & UpdateCustomerReturnErrorInterface & UpdateNameErrorInterface & UpdateRequestRequisitionErrorInterface & {
  __typename: 'OtherPartyNotACustomer';
  description: Scalars['String']['output'];
};

export type OtherPartyNotASupplier = InsertFromResponseRequisitionErrorInterface & InsertInboundShipmentErrorInterface & InsertRequestRequisitionErrorInterface & InsertSupplierReturnErrorInterface & UpdateInboundShipmentErrorInterface & UpdateRequestRequisitionErrorInterface & UpdateReturnOtherPartyErrorInterface & {
  __typename: 'OtherPartyNotASupplier';
  description: Scalars['String']['output'];
};

export type OtherPartyNotVisible = InsertCustomerReturnErrorInterface & InsertErrorInterface & InsertFromResponseRequisitionErrorInterface & InsertInboundShipmentErrorInterface & InsertRequestRequisitionErrorInterface & InsertResponseRequisitionErrorInterface & InsertSupplierReturnErrorInterface & UpdateCustomerReturnErrorInterface & UpdateInboundShipmentErrorInterface & UpdateNameErrorInterface & UpdateRequestRequisitionErrorInterface & UpdateReturnOtherPartyErrorInterface & {
...
export type PackSizeCodeCombinationExists = InsertPurchaseOrderLineErrorInterface & {
...
export type PatientSortFieldInput =
  | 'address1'
  | 'address2'
  | 'code'
  | 'code2'
...
export type PluginDataSortFieldInput =
  | 'datetime'
  | 'id'
  | 'pluginCode';
...
export type PreferenceValueNodeType =
  | 'BACKDATING_DATA'
  | 'BOOLEAN'
  | 'COLOUR'
  | 'CUSTOM_TRANSLATIONS'
...
export type ProgramEnrolmentSortFieldInput =
  | 'enrolmentDatetime'
  | 'patientId'
  | 'programEnrolmentId'
  | 'status'
...
export type ProgramEventSortFieldInput =
  | 'activeEndDatetime'
  | 'activeStartDatetime'
  | 'datetime'
  | 'documentName'
...
export type ProgramIndicatorSortFieldInput =
  | 'code'
  | 'programId';
...
export type ProgramSortFieldInput =
  | 'name';
...
export type PropertyNodeValueType =
  | 'BOOLEAN'
  | 'DATE'
  | 'FLOAT'
  | 'INTEGER'
...
export type PurchaseOrderLineSortFieldInput =
...
export type PurchaseOrderLineStatusNode =
  | 'CLOSED'
  | 'NEW'
  | 'SENT';

export type PurchaseOrderLineWithIdExists = InsertPurchaseOrderLineErrorInterface & {
...
export type PurchaseOrderNodeStatus =
  | 'CONFIRMED'
  | 'FINALISED'
  | 'NEW'
  | 'REQUEST_APPROVAL'
...
export type PurchaseOrderSortFieldInput =
  | 'createdDatetime'
  | 'number'
  | 'status'
  | 'targetMonths';
...
export type QueriesShippingMethodsArgs = {
...
export type ReasonOptionSortFieldInput =
  | 'reason'
  | 'reasonOptionType';
...
export type RefreshAncillaryItemsAction =
...
export type RefreshAncillaryItemsResponse = RefreshAncillaryItemsError | RefreshAncillaryItemsSuccess;
...
export type ReportSortFieldInput =
  | 'code'
  | 'id'
  | 'name'
  | 'version';
...
export type RequisitionNodeApprovalStatus =
  /** Approved */
  | 'APPROVED'
  | 'APPROVED_BY_ANOTHER'
  | 'AUTO_APPROVED'
...
export type RequisitionNodeStatus =
...
export type RequisitionNodeType =
...
export type RequisitionReasonNotProvided = UpdateRequestRequisitionLineErrorInterface & UpdateResponseRequisitionLineErrorInterface & {
...
export type RequisitionSortFieldInput =
  | 'comment'
  | 'createdDatetime'
  | 'expectedDeliveryDate'
  | 'finalisedDatetime'
...
export type ResponseAddFromMasterListError = {
  __typename: 'ResponseAddFromMasterListError';
  error: ResponseAddFromMasterListErrorInterface;
};

export type ResponseAddFromMasterListErrorInterface = {
  description: Scalars['String']['output'];
};
...
export type ResponseAddFromMasterListResponse = RequisitionLineConnector | ResponseAddFromMasterListError;
...
export type ReturnReasonSortFieldInput =
  | 'id'
  | 'reason';
...
export type RnRFormNodeStatus =
  | 'DRAFT'
  | 'FINALISED';

export type RnRFormResponse = NodeError | RnRFormNode;

export type RnRFormSortFieldInput =
  | 'createdDatetime'
  | 'period'
  | 'program'
  | 'status'
...
export type SensorFilterInput = {
  ...
  name?: InputMaybe<StringFilterInput>;
  serial?: InputMaybe<StringFilterInput>;
  type?: InputMaybe<EqualFilterSensorTypeInput>;
};
...
export type SensorSortFieldInput =
  | 'name'
  | 'serial';
...
export type SiteSortFieldInput =
  | 'code'
  | 'id'
  | 'name';
...
export type StockLineOnHold = InsertStockRelocationErrorInterface & UpdateStockRelocationErrorInterface & {
...
export type StockLineSortFieldInput =
  | 'batch'
  | 'costPricePerPack'
  | 'expiryDate'
  | 'itemCode'
...
export type StockRelocationNodeStatus =
  | 'FINALISED'
  | 'NEW';

export type StockRelocationResponse = RecordNotFound | StockRelocationNode;

export type StockRelocationSortFieldInput =
  | 'batch'
  | 'createdDatetime'
  | 'expiryDate'
  | 'finalisedDatetime'
...
export type StocktakeLineSortFieldInput =
  | 'batch'
...
export type StocktakeNodeStatus =
  | 'FINALISED'
  | 'NEW';

export type StocktakeResponse = NodeError | StocktakeNode;

export type StocktakeSortFieldInput =
  | 'comment'
  | 'createdDatetime'
  | 'description'
  | 'finalisedDatetime'
...
export type StoreSortFieldInput =
  | 'code'
  | 'name'
  | 'nameCode';
...
export type SyncErrorVariantV7 =
  | 'AUTHENTICATION'
  | 'CONNECTION_ERROR'
  | 'DATABASE_ERROR'
  | 'FAILED_TO_GET_HARDWARE_ID'
  | 'GET_CURRENT_SITE_ID_ERROR'
  | 'HARDWARE_ID_MISMATCH'
  | 'INTEGRATION_TIMEOUT_REACHED'
  | 'INVALID_SITE_NAME_OR_PASSWORD'
  | 'MISSING_AUTH_HEADER'
  | 'NOT_A_CENTRAL_SERVER'
  | 'OTHER'
  | 'PARSING_ERROR'
  | 'RECORD_NOT_FOUND'
  | 'REQUEST_SITE_AUTH_ERROR'
  | 'SITE_ID_MISMATCH'
  | 'SITE_ID_NOT_SET'
  | 'SITE_IS_NOT_V7'
  | 'SITE_LOCK_ERROR'
  | 'SYNC_RECORD_SERIALIZE_ERROR'
...
export type SyncFileReferenceNodeStatus =
  | 'DONE'
  | 'ERROR'
  | 'IN_PROGRESS'
  | 'NEW'
...
export type SyncMessageNodeStatus =
  | 'error'
  | 'inProgress'
  | 'new'
  | 'processed';

export type SyncMessageNodeType =
  | 'other'
  | 'requestFieldChange'
  | 'supportUpload';
...
export type SyncMessageRowTypeInput =
  | 'SUPPORT_UPLOAD';

export type SyncMessageSortFieldInput =
  | 'createdDatetime'
  | 'id'
  | 'status';
...
export type SyncRequestDescriptionNode = AllStoreDataDescription | TableNameDescription;
...
export type TemperatureBreachNodeType =
  | 'COLD_CONSECUTIVE'
  | 'COLD_CUMULATIVE'
  | 'EXCURSION'
  | 'HOT_CONSECUTIVE'
...
export type TemperatureBreachSortFieldInput =
  | 'endDatetime'
  | 'startDatetime';
...
export type TemperatureLogSortFieldInput =
  | 'datetime'
  | 'temperature';
...
export type UniqueCombinationKey =
  | 'manufacturer'
  | 'model';
...
export type UpdateCustomerReturnStatusInput =
  | 'RECEIVED'
  | 'VERIFIED';
...
export type UpdateInboundShipmentStatusInput =
  | 'DELIVERED'
  | 'RECEIVED'
  | 'SHIPPED'
  | 'VERIFIED';
...
export type UpdateOutboundShipmentStatusInput =
  | 'ALLOCATED'
  | 'PICKED'
  | 'SHIPPED';
...
export type UpdatePurchaseOrderLineResponse = IdResponse | UpdatePurchaseOrderLineError;
...
export type UpdateRequestRequisitionInput = {
  colour?: InputMaybe<Scalars['String']['input']>;
  comment?: InputMaybe<Scalars['String']['input']>;
  destinationCustomerId?: InputMaybe<NullableStringUpdate>;
  expectedDeliveryDate?: InputMaybe<Scalars['NaiveDate']['input']>;
  id: Scalars['String']['input'];
  maxMonthsOfStock?: InputMaybe<Scalars['Float']['input']>;
  minMonthsOfStock?: InputMaybe<Scalars['Float']['input']>;
...
export type UpdateRequestRequisitionStatusInput =
  | 'SENT';
...
export type UpdateResponseRequisitionStatusInput =
  | 'FINALISED';
...
export type UpdateStockRelocationResponse = UpdateStockRelocationError | UpdateStockRelocationNode;
...
export type UpdateStocktakeStatusInput =
  | 'FINALISED';
...
export type UpdateSupplierReturnStatusInput =
  | 'PICKED'
  | 'SHIPPED';

export type UpdateSyncSettingsResponse = SyncErrorNode | SyncErrorV7Node | SyncSettingsNode;
...
export type UploadedPluginErrorVariant =
  | 'CANNOT_PARSE_FILE';
...
export type UpsertAncillaryItemResponse = AncillaryItemNode | UpsertAncillaryItemError;
...
export type UpsertPreferencesInput = {
  ...
  canCreateInternalOrderFromARequisition?: InputMaybe<Array<BoolStorePrefInput>>;
  ...
  externalInboundShipmentLinesMustBeAuthorised?: InputMaybe<Array<BoolStorePrefInput>>;
  ...
  numberOfMonthsThresholdToShowLowStockAlertsForProducts?: InputMaybe<Array<FloatStorePrefInput>>;
  numberOfMonthsThresholdToShowOverStockAlertsForProducts?: InputMaybe<Array<FloatStorePrefInput>>;
  numberOfMonthsToCheckForConsumptionWhenCalculatingOutOfStockProducts?: InputMaybe<Array<IntegerStorePrefInput>>;
  orderInPacks?: InputMaybe<Array<BoolStorePrefInput>>;
  preventTransfersMonthsBeforeInitialisation?: InputMaybe<Scalars['Int']['input']>;
  ...
  selectDestinationStoreForAnInternalOrder?: InputMaybe<Array<BoolStorePrefInput>>;
  ...
  warnWhenMissingRecentStocktake?: InputMaybe<Array<WarnWhenMissingRecentStocktakeInput>>;
...
export type VaccinationCardItemNodeStatus =
  | 'GIVEN'
  | 'LATE'
  | 'NOT_GIVEN'
  | 'PENDING';
...
export type VaccineCourseSortFieldInput =
  | 'name';
